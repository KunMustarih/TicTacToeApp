...
import edu.Truman.Board;
import edu.Truman.Player;
...
public class CompPlayer extends Player {
    ...
    public int compuTerWinCheck() {
        ...
        // checking if there is a possible diagnol combination that can be used to win
    ...
    //Checks if the human player is going to win and stops it
    public int humanWinCheck() {
        int position = 0;
    ...
    public int CompNextMove()
    {
        ...
        int move_number = 0;
        int cwc = compuTerWinCheck();
        int hwc =humanWinCheck();
        if (cwc > -1)
            return cwc;
